...
| 194 | East Asian trees get a message instead of a PDF, pointing at the browser's print-to-PDF. | A Noto CJK face is several megabytes as TrueType — far larger than any family tree — and subsetting a CJK font is a bigger machine than this app should carry. | decided |
